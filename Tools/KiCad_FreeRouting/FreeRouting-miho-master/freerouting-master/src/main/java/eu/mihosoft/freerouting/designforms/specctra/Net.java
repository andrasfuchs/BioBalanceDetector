...
public class Net
{
    ...
    public static void write_scope(WriteScopeParameter p_par, eu.mihosoft.freerouting.rules.Net p_net, Collection<eu.mihosoft.freerouting.board.Pin> p_pin_list) throws java.io.IOException
    {
        ...
        Iterator<eu.mihosoft.freerouting.board.Pin> it = p_pin_list.iterator();
        while (it.hasNext())
        {
            eu.mihosoft.freerouting.board.Pin curr_pin = it.next();
    ...
    public static void write_net_id(eu.mihosoft.freerouting.rules.Net p_net, IndentFileWriter p_file, IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.write("net ");
    ...
    public static void write_pin(WriteScopeParameter p_par, eu.mihosoft.freerouting.board.Pin p_pin) throws java.io.IOException
    {
